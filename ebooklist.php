	...
	<!-- isi -->
		<div class="w3-bar">
			<?php
				...
				$query = "SELECT DISTINCT Kategori FROM tbl_book";
				$ebook->viewEbookberdasarkankategori($query);
			?>	
		</div>
		
		<div class="w3-container">
			<input type="text" id="searchbook" class="form-control mt-lg-3 mb-lg-2" style="font-family: FontAwesome;" placeholder="&#61442; Judul Ebook...">
			
				<div id="tampilbook">
					<?php							
						$query = "SELECT * FROM tbl_book ORDER BY id_book ASC";
