...
<body>
	...
	<?php
		...
		if(isset($_POST['btn_tambah'])){
			...
			if($nik == '' || $nama == '' || $username == '' || $password == ''	|| $confirm_pass == ''){
				echo'
				...
				if($password == $confirm_pass){
					$pustakawan->InsertAdminBaru($nik,$nama,$username,$password);
						...
						<div class="alert alert-success d-flex alert-dismissible align-items-center w3-animate-opacity" role="alert" style="margin-left: 155px;">
							...
							<div>
								Data berhasil di simpan <i class="bi bi-emoji-smile"></i>
							</div>
							<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
						</div>';
				}
					...
					<form action="" method="post">
						<div class="mt-sm-5">
							...
							<h2>Tambah Pustakawan</h2>
								...
								<div class="input-group mt-sm-4">
									<input type="text" class="form-control" name="nik"  autocomplete="off" placeholder="NIK">
								</div>
						...
						<div class="row ">
							...
							<div class="col-lg-6" >
								...
								<div class="input-group-password mt-sm-4">
									<input type="password" class="form-control" name="confirm_password" autocomplete="off" placeholder="TULIS ULANG PASSWORDS">
								</div>
						...
						<div class="mt-sm-4">
							<button type="submit" name="btn_tambah" class="btn btn-success bi bi-person-plus-fill w3-right">  Tambah</button>
						</div>
					</form>
			</div>
		</div>
	...
	<!-- footer -->
		<div class="w3-bar w3-blue w3-display-bottommiddle w3-card w3-block">
