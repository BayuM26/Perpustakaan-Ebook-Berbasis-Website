...
<body>
	...
	<!-- isi -->
		<div class="w3-container mt-sm-5" style="margin-left: 170px; min-height:600px;">
			...
			<h2 class='w3-center'>DATA EBOOK</h2>

			<div class="row">
				<div class="col-lg-3">
					<input type="text" id="searchEbook" class="form-control mt-lg-3 mb-lg-2" style="font-family: FontAwesome;" placeholder="&#61442; Judul Ebook...">
				</div>

				<div class=" offset-lg-3 col-lg-3">
					<a target="_blank" href="../tindakan/exportReportPdf.php">
						<button type="submit" class="w3-right btn btn-outline-danger mt-lg-3 mb-lg-2">
							<img src="../lib/img/export_pdf.png" width="30px">
							EXPORT REPORT
						</button>
					</a>
				</div>
				...
				<div class=" col-lg-3">
					<a href="../tindakan/exportReport.php">
						<button type="submit" class="btn btn-outline-success mt-lg-3 mb-lg-2">
							<img src="../lib/img/export.png" width="30px">
							EXPORT REPORT
						</button>
					</a>
				</div>
			...
			<div class="w3-responsive">
				<table class="w3-table-all w3-hoverable mb-lg-5">
					<thead>
					...
					<tbody id="tampilEbook">	
						<?php
							require_once '../class/ebook.php';
							
							$query = "SELECT * FROM tbl_book tb, tbl_penerbit tp WHERE tb.id_book = tp.id_penerbit";
