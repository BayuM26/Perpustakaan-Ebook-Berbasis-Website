...
<body>
	...
	<!-- isi -->
		<div class="w3-container mt-sm-5" style="margin-left: 170px; min-height: 600px;" >
			...
			<div class="col">
				<div class="col-lg-3">
					<input type="text" id="searchAdmin" class="form-control mt-lg-3 mb-lg-2" style="font-family: FontAwesome;" placeholder="&#61442; Nama Admin...">
				</div>
			</div>
				...
				<table class="w3-table-all w3-hoverable mb-lg-5">
					...
					<tbody id="tampilAdmin">
						<?php
							...
							$query = "SELECT * FROM tbl_pustakawan ORDER BY id_pustakawan ASC";
